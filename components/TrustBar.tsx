  ...
  return (
    <Section>
      <div className="premium-panel p-6 sm:p-8">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">Trust & Proof</p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-5">
          ...
          <Link href="/reviews" className="glass-card bg-cyan-500/10 p-4 text-sm font-semibold text-cyan-100">
