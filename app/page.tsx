  ...
  return (
    <main>
      ...
      <Section>
        ...
        <Link href="/gallery" className="mt-5 inline-block font-semibold text-sky-200">View Full Gallery →</Link>
      </Section>
      ...
      <Section>
        <div className="premium-panel p-6 sm:p-8">
          ...
          <Link href="/reviews" className="mt-5 inline-block font-semibold text-sky-200">Read All Reviews →</Link>
        </div>
      </Section>
      ...
      <Section>
        <div className="glass-card p-6 sm:p-8">
          ...
          <Link href="/commercial-hoa" className="mt-5 inline-block rounded-md bg-sky-500 px-5 py-3 font-semibold text-slate-950 transition hover:bg-sky-400">
