...
export default function Hero() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24">
      <div className="hero-glow -left-10 top-12 h-44 w-44 bg-cyan-400/20" />
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        <div className="relative">
          <p className="inline-flex items-center rounded-full border border-cyan-400/40 bg-cyan-400/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/contact"
              className="rounded-md border border-slate-300/40 bg-white px-5 py-3 font-semibold text-slate-900 transition hover:bg-cyan-100"
            >
              Request a Quote
            </Link>
          </div>
          <p className="mt-6 text-sm font-medium uppercase tracking-wide text-cyan-100/90">
            Trusted by homeowners, veterans, and property managers across Greater Houston.
          </p>
        </div>

        <div className="premium-panel relative p-6">
          <div className="absolute -inset-1 -z-10 rounded-[1.75rem] bg-gradient-to-br from-cyan-400/20 via-transparent to-blue-500/20 blur-2xl" />
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-cyan-200">Proof of Quality</p>
          ...
          <div className="mt-5 glass-card p-4 text-sm text-slate-200">
            <p className="font-semibold text-cyan-200">Veteran-Owned Promise</p>
