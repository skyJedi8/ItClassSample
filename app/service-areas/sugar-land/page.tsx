...
export const metadata = getMetadata('Exterior Cleaning in Sugar Land, TX | Operation Clean Freedom','Professional gutter, window, roof soft wash, pressure washing, and drainage cleaning in Sugar Land, TX.','/service-areas/sugar-land');

const faqs=[
{q:'How does Sugar Land weather affect exteriors?',a:'Humidity, pollen, and algae buildup can quickly impact curb appeal and drainage performance.'},
