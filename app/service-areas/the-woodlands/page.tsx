...
export const metadata = getMetadata('Exterior Cleaning in The Woodlands, TX | Operation Clean Freedom','Professional gutter, window, roof soft wash, pressure washing, and drainage cleaning in The Woodlands, TX.','/service-areas/the-woodlands');

const faqs=[
{q:'How does The Woodlands weather affect exteriors?',a:'Humidity, pollen, and algae buildup can quickly impact curb appeal and drainage performance.'},
