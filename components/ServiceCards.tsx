    ...
    <div className="grid gap-5 md:grid-cols-3">
      {services.map((service) => (
        ...
        >
          ...
          <p className="mt-4 text-sm font-semibold text-brand-200">Learn more →</p>
        </Link>
      ))}
      <Link href="/services#bundles" className="glass-card p-6">
        <p className="text-xs font-semibold uppercase tracking-[0.15em] text-brand-200">Efficiency Bundle</p>
