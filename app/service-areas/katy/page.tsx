...
export const metadata = getMetadata('Exterior Cleaning in Katy, TX | Operation Clean Freedom','Professional gutter, window, roof soft wash, pressure washing, and drainage cleaning in Katy, TX.','/service-areas/katy');

const faqs=[
{q:'How does Katy weather affect exteriors?',a:'Humidity, pollen, and algae buildup can quickly impact curb appeal and drainage performance.'},
