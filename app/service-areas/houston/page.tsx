...
export const metadata = getMetadata('Exterior Cleaning in Houston, TX | Operation Clean Freedom','Professional gutter, window, roof soft wash, pressure washing, and drainage cleaning in Houston, TX.','/service-areas/houston');

const faqs=[
{q:'How does Houston weather affect exteriors?',a:'Humidity, pollen, and algae buildup can quickly impact curb appeal and drainage performance.'},
