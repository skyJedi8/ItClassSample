...
const proofImages = [
  ...
  { src: '/images/projects/pwr3.png', alt: 'Operation Clean Freedom exterior cleaning project' },
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden py-16 sm:py-24">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8">
        <div className="relative">
          ...
          <h1 className="mt-5 text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
            Exterior Cleaning Done With Discipline, Care, and Clear Communication.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">
            Operation Clean Freedom provides gutter cleaning, window cleaning, roof soft washing, pressure washing, and drainage cleaning for homes, rentals, HOAs, and commercial properties across Greater Houston.
          </p>
        ...
        <div className="premium-panel relative p-5 sm:p-6">
          ...
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand-200">Real Local Work</p>
          <p className="mt-2 text-sm text-slate-300">Recent pressure-washing results from Operation Clean Freedom projects.</p>
          ...
          <div className="mt-5 glass-card p-4 text-sm text-slate-200">
            <p className="font-semibold text-brand-200">Veteran-Owned Standard</p>
            <p className="mt-1 text-slate-300">Clear scope confirmation, careful property protection, and a final walkthrough before the job is closed out.</p>
          </div>
        </div>
      </div>
    </section>
