    ...
    <div className="grid gap-5 md:grid-cols-3">
      {services.map((service) => (
        <Link
          ...
          className="glass-card group p-6 transition hover:-translate-y-1 hover:border-cyan-300/50"
        >
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-cyan-200">Veteran-Owned Service</p>
          ...
          <p className="mt-4 text-sm font-semibold text-cyan-200">Learn more →</p>
        </Link>
      ))}
      <Link href="/services#bundles" className="glass-card p-6">
        <p className="text-xs font-semibold uppercase tracking-[0.15em] text-cyan-200">Efficiency Bundle</p>
